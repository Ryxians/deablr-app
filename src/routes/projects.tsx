...
import { Dices, MessageCircle, SlidersHorizontal } from "lucide-react"
    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="text-muted-foreground mb-6">
          A collection of games, tools, and experiments built for this digital abode.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="hover:border-primary/50 transition-colors">
            ...
            <CardContent className="space-y-4">
              <p className="text-muted-foreground">
                Upload a video, tweak its EQ, compare changes, and export the
                result — all in the browser.
              </p>
              <Link to="/eq">
                <Button className="w-full">Open EQ</Button>
              </Link>
            </CardContent>
          </Card>
